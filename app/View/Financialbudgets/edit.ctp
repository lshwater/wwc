...
<div class="panel">
    ...
    <?php echo $this->Form->input('id', array('value'=>$budgetdetail['Financialbudget']['id'])); ?>
                ...
                <div class="row clearfix">
                    <div class="col-sm-12 column">
                        <table class="table table-bordered table-hover" id="tab_income">
                            ...
                            <?foreach($budgetdetail['Financialbudgetincome'] as $incomedetail){
                                $row++;
                            ...
                            <tr id="record<?=$row?>">
                                ...
                                <?php echo $this->Form->input("Financialbudgetdetail.{$row}.id", array('value'=>$incomedetail['id'])); ?>
                                <td class="col-sm-4">
                                    <div class="form-group no-margin no-padding">
                                        <?php echo $this->Form->select("Financialbudgetdetail.{$row}.financialitem_id", $income, array('value'=>h($incomedetail['financialitem_id']),'div'=>false, 'label'=>false, 'class'=>'form-control select2-multiple', 'required'=> 'required'));?>
                                    </div>
                                </td>
                                <td class="col-sm-2">
                                    <div class="form-group no-margin no-padding">
                                        <?php echo $this->Form->input("Financialbudgetdetail.{$row}.quantity", array('value'=>h($incomedetail['quantity']),'type'=>'text', 'min'=>'0', 'div'=>false, 'label'=>false, 'required'=>'required', 'class'=>'form-control vd_number quantity', 'placeholder'=>__('Quantity')));?>
                                    </div>
                                </td>
                                <td class="col-sm-2">
                                    <div class="form-group no-margin no-padding">
                                        <?php echo $this->Form->input("Financialbudgetdetail.{$row}.unit_cost", array('value'=>h($incomedetail['unit_cost']),'type'=>'text', 'min'=>'0', 'step'=>'0.01', 'div'=>false, 'label'=>false, 'required'=>'required', 'class'=>'form-control vd_number cost', 'placeholder'=>__('Cost')));?>
                                    </div>
                                </td>
                                <?php echo $this->Form->hidden("Financialbudgetdetail.{$row}.type", array('value'=>h($incomedetail['type'])));?>
                                <td class="col-sm-2">
                                    <div class="form-group no-margin no-padding">
                ...
                <div class="row clearfix">
                    <div class="col-sm-12 column">
                        <table class="table table-bordered table-hover" id="tab_expense">
                            ...
                            <?foreach($budgetdetail['Financialbudgetexpense'] as $expensedetail){
                                $row++;
                            ?>
                            <tr id="record<?=$row?>">
                                <td class="col-sm-1">
                                ...
                                <?php echo $this->Form->input("Financialbudgetdetail.{$row}.id", array('value'=>$expensedetail['id'])); ?>
                                <td class="col-sm-4">
                                    <div class="form-group no-margin no-padding">
                                        <?php echo $this->Form->select("Financialbudgetdetail.{$row}.financialitem_id", $expense, array('value'=>h($expensedetail['financialitem_id']), 'div'=>false, 'label'=>false, 'class'=>'form-control select2-multiple', 'required'=> 'required'));?>
                                    </div>
                                </td>
                                <td class="col-sm-2">
                                    <div class="form-group no-margin no-padding">
                                        <?php echo $this->Form->input("Financialbudgetdetail.{$row}.quantity", array('value'=>h($expensedetail['quantity']), 'type'=>'text', 'min'=>'0', 'div'=>false, 'label'=>false, 'required'=>'required', 'class'=>'form-control vd_number quantity', 'placeholder'=>__('Quantity')));?>
                                    </div>
                                </td>
                                <td class="col-sm-2">
                                    <div class="form-group no-margin no-padding">
                                        <?php echo $this->Form->input("Financialbudgetdetail.{$row}.unit_cost", array('value'=>h($expensedetail['unit_cost']), 'type'=>'text', 'min'=>'0', 'step'=>'0.01', 'div'=>false, 'label'=>false, 'required'=>'required', 'class'=>'form-control vd_number cost', 'placeholder'=>__('Cost')));?>
                                    </div>
                                </td>
                                <?php echo $this->Form->hidden("Financialbudgetdetail.{$row}.type", array('value'=>h($expensedetail['type'])));?>
                                <td class="col-sm-2">
                                    <div class="form-group no-margin no-padding">
