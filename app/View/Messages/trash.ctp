...
<div class="mail-container">
    <div class="mail-container-header">
        <i class="fa fa-trash-o"></i> <?=__('垃圾桶')?>
    </div>
    ...
    <?
    echo $this->Form->create('Message', array("id"=>"messageform", "action"=>"unlinkmsg", "class"=>"validate_form preventDoubleSubmission"));
    ...
    if(!empty($messages)){
        ...
        <ul class="mail-list">
            ...
            foreach($messages as $message){
                ...
                ?>
                <li class="mail-item <?=$unread?> <?=$starred?> message">
                    <div class="m-chck">
...
//        $("body").addClass("page-mail mmc ");
        ...
        $("#email_menu_trash").addClass("active");
