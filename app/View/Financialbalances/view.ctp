...
<div class="panel">
    <div class="panel-heading">
        ...
        <div>
            <?=__('最後更新時間')?> ：
            <?=h($balancedetail['Financialbalance']['modified'])?>
        </div>
    </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="col-sm-2 text-right">
                                    <?php echo h($income['unit_cost']); ?>&nbsp;
                                </td>
                                <td class="col-sm-2 text-right">
                                    <?php echo h($income['unit_cost']*$income['quantity']); ?>
                                </td>
                            </tr>
                            <?
                            }
                    ...
                    <div class="col-sm-12 column">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="col-sm-2 text-right">
                                    <?php echo h($expense['unit_cost']); ?>&nbsp;
                                </td>
                                <td class="col-sm-2 text-right">
                                    <?php echo h($expense['unit_cost']*$expense['quantity']); ?>
                                </td>
                            </tr>
                            <?
                            }
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-6" align="right">
                            ...
                            <div class="col-md-4">
                                <h3><?=h($balancedetail['Financialbalance']['total_income'])?></h3>
                            </div>
                        </div>
                        <div class="col-xs-6" align="right">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <h3><?=h($balancedetail['Financialbalance']['total_expense'])?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-6" align="right">
                            ...
                            <div class="col-md-4">
                                <h3><?=h($balancedetail['Financialbalance']['total_income'] - $balancedetail['Financialbalance']['total_expense'])?></h3>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--            --><?//=__('總預支金額')?><!-- ：-->
<!--            --><?//
//            foreach($balancedetail[0]['Prepayment'] as $prepayment){
//                $total_prepayment += $prepayment['amount'];
//            }
//            echo $total_prepayment;
//            ?>
<!--        </div>-->
<!--        --><?php //echo $this->Html->link('<button class="btn btn-sm btn-info" style="width: 30px;"><i class="fa fa-plus"></i></button>', array('action' => 'addprepayment', $balancedetail[0]['Financialbalance']['id'], $id, $model, 'redirect'=>urlencode($redirecturl), 'apex'=>true), array('class'=>'', 'escape'=>false, 'data-toggle'=>"modal", 'data-target'=>'#modal')); ?>
<!--    </div>-->
<!--    <div class="panel-body">-->
