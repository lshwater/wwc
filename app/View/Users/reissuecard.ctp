...
<div class="panel">
    <?php echo $this->Form->create('User', array('class'=>'form-horizontal validate_form preventDoubleSubmission') ); ?>
    <div class="panel-body">
        <?php echo $this->Form->input('id'); ?>
        <div class="form-group">
            <?php echo $this->Form->label("smartcard", __('配對智能卡'), 'col-sm-3 control-label'); ?>
            <div class="col-sm-9">
                <?php echo $this->Form->input("smartcard", array('div'=>false, 'label'=>false, 'class'=>'form-control smartcard', "readonly"=>"readonly"));?>
            </div>
        </div> <!-- / .form-group -->
    </div>
