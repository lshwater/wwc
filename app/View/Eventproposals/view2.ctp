        ...
        ?>
                ...
                ?>
                        <ul class="nav nav-tabs nav-tabs-simple" id="profile-tabs">
                            ...
                            ?>
                                <li <?=$active?>>
                                    <a href="#profile-tabs-<?=$ac['id']?>" data-toggle="tab"><?=h($ac['name'])?><?=$acode?> <?=$cancellable?> <?=$closelabel?></a>
                                </li>
                            <?
                                $active = "";
                            }
                        ...
                        <div class="tab-content tab-content-bordered panel-padding">
                            ...
                            ?>
                                <div class="tab-pane panel colourable fade in <?=$active?>" id="profile-tabs-<?=$ac['id']?>">
                                    <?
                                    if(!$ac['publish']){
                                        ?>
                                        <div class="panel panel-info">
                                            <div class="panel-heading">
                                                ...
                                                <div class="panel-heading-controls">
                                                    <?php echo $this->Form->postLink('確認活動', array("controller"=>"activities", "action"=>"publish", $ac['id']), array('escape'=>false, "class"=>"btn btn-info"), __('你確定要確認活動 %s?', $ac['name'])); ?>
                                                </div>
                                            </div>
                                            <div class="panel-body">
                                    ...
                                    ?>
                                        ...
                                        <div class="panel-body">
                                            <table class="table table-striped table-bordered table-condensed table-hover">
                                                ...
                                                <tr>
                                                    <th colspan="4" class="success">收費項目</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="2">名稱</th>
                                                    <th>每節收費</th>
                                    ...
                                    <div class="panel-heading">
                                        <span class="panel-title">資源</span>
                                        <?
                                        if($activitycanedit){
                                            ?>
                                            <div class="panel-heading-controls">
...
<!--                                            系統文件-->
                                        <div class="panel-slimscroll panel-info">
                                            <div class="panel-heading">
                                                <span class="panel-title"><i class="panel-title-icon fa fa-folder-o"></i>相關文件</span>
                                            </div> <!-- / .panel-heading -->
                                            <div class="panel-body tab-content-padding">
                                                <!-- Panel padding, without vertical padding -->
                                                    <div class="panel-padding no-padding-vr widget-comments">
                                                        <div class="comment">
...
<!--                                            上傳文件-->
                                        <div class="panel-slimscroll panel-success ">
                                            <div class="panel-heading">
                                                    ...
                                                    <div class="panel-padding no-padding-vr widget-comments">
                                                        ...
                                                        foreach($ac['Attachment'] as $att){
                                                            ...
                                                            <div class="comment">
                                                                <div class="comment-body" style="margin-left: 0">
                                                                    <div class="comment-by">
                                                                        <a href="#" title=""><?=h($att['name'])?></a> Uploaded by <a href="#" title=""><?=h($att['User']['name'])?></a>
                                                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group no-margin-hr">
                    <?php echo $this->Form->input('cloneevent_id', array('div'=>false, 'label'=>false, "id"=>"cloneevent_id",'class'=>'form-control select2', "options"=>$eventlists, "default"=>$eventproposal['Eventproposal']['id']));?>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        if( taburl.match('#') ) {
            $('#profile-tabs a[href=#'+taburl.split('#')[1]+']').click();
        }
        $(".datatable").dataTable({
            searching: false,
            lengthChange: false,
