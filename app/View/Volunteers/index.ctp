        ...
        <div class="col-xs-12 col-sm-8">
            <div class="row">
                ...
                <div class="text-right col-xs-12 col-sm-auto">
                    <?php echo $this->Html->link('<span class="icon fa fa-plus"></span>'.__('新增義工'), array("action"=>"add"), array('escape'=>false, 'class'=>'btn btn-primary btn-labeled')); ?>
                    <?php echo $this->Html->link('<span class="icon fa fa-university"></span>'.__('義工機構'), array("controller"=>'volunteerunits',"action"=>"index"), array('escape'=>false, 'class'=>'btn btn-primary btn-labeled')); ?>
