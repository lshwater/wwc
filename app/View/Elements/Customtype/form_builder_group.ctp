    ...
    <div class="panel-body">
        ...
        foreach($layout['nogroup'] as $k=>$field){
            ...
            if(!$field['hidden']){
                ...
                <div class="<?=$field['div_class']?>" style="min-height: 76px !important;">
                        <div class="form-group">
                            ...
                            if(!empty($custom_field[$field['field_id']])){
                                $options['value'] = $custom_field[$field['field_id']]['value'];
                            }
...
//                                        $options['empty'] = 'true';
                                    ...
                                    if($field['multiple']){
                                        $options['class'] .=  " select2-multiple";
                                ...
                                case 'bool':
                                    ...
                                    $options['value'] = 1;
                                    if(!empty($custom_field[$field['field_id']]['value'])){
