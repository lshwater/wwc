    ...
    <div class="col-sm-12">
        ...
        <div class="modal-header">
            <h3 class="modal-title">
                更新 <?=$type['Dbmodel']['oname']?> - <?=$type['Customtype']['type_oname']?> <p class="label label-info"><?=$field['Customfield']['alias']?></p>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('div_class', array('div'=>false, 'label'=>false,'class'=>'form-control', 'required'=>'required'));?>
                </div>
            </div>
