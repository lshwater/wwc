...
<div class="page-header">
    <div class="row">
        ...
        <h1 class="col-xs-12 flashMessage">
            <i class="fa fa-search page-header-icon"></i>&nbsp;歸還物品
        </h1>
...
<!--            <div class="col-sm-9">-->
<!--                --><?php //echo $this->Form->input("parentcard", array('div'=>false, 'label'=>false, 'class'=>'form-control parentcard', "readonly"=>"readonly"));?>
<!--            </div>-->
<!--            <div class="col-sm-1">-->
                ...
                <div class="table-default">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables">
                        ...
                        <tr>
                            ...
                            <th style="width:10%"><?php echo __('Fix Asset No.'); ?></th>
                            <th style="width:20%"><?php echo __('物品名稱'); ?></th>
                            <th style="width:10%"><?php echo __('Unit'); ?></th>
                            <th style="width:10%"><?php echo __('數量'); ?></th>
                            <th style="width:15%">借出時間</th>
                            <th style="width:15%">歸還時間</th>
                            <th><?=__('行動')?></th>
                        </tr>
                        </thead>
                        <tbody>
