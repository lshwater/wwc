<div class="row">
    <div class="col-sm-12">
        ...
        <?php echo $this->Form->hidden('casemanagementform_id');?>
        ...
        <div class="modal-body">
            ...
            <div class="form-group case_referral_agency" <?=(!empty($this->request->data['Casecloseform']['case_referral_agency']))?"":"hidden"?>>
            ...
            <div class="form-group other_specify" <?=(!empty($this->request->data['Casecloseform']['other_specify   ']))?"":"hidden"?>>
