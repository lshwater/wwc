<div class="row">
    <div class="col-sm-12">
        <?php echo $this->Form->create('ActivitiesVolunteer', array('class'=>'panel form-horizontal validate_form')); ?>

        <div class="panel-heading">
            <span class="panel-title">編輯參加義工資料</span>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="form-group col-xs-12">
                    <?php echo $this->Form->label('email', __('電郵'), 'col-sm-2 control-label'); ?>
                    <div class="col-sm-10">
                        <?php echo $this->Form->input('email', array('div'=>false, 'label'=>false, 'type'=>"text",'class'=>'form-control vd_email'));?>
                    </div>
                </div> <!-- / .form-group -->
            </div>
            <div class="row">
