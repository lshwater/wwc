...
//        $this->request->allowMethod('post', 'delete');
    ...
    public function add($case_id=null){
        ...
        $this->set('servicerecords', $this->Servicerecord->Servicerecordtype->find('list', array('conditions' => array('active' => 1))));
    ...
    public function add_from_schedule(){
        ...
        if ($this->request->is(array('post', 'put'))) {
            ...
            $this->redirect(array("controller" => "Casemanagements", "action" => "schedule", $case_id));
        }
