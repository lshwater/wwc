...
<div class="panel">
    ...
    <?php echo $this->Form->create('Activity', array('class'=>'validate_form preventDoubleSubmission')); ?>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group no-margin-hr">
                <?php echo $this->Form->label('trafficgroup', __('交通分組 (如有)'), 'control-label'); ?>
                <?php echo $this->Form->input('trafficgroup', array('div'=>false, 'label'=>false, 'default'=>'A,B,C,D,E,F,G', 'class'=>'form-control'));?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group no-margin-hr">
                <?php echo $this->Form->label('mealgroup', __('飯食分組 (如有)'), 'control-label'); ?>
                <?php echo $this->Form->input('mealgroup', array('div'=>false, 'label'=>false,  'default'=>'1,2,3,4,5,6,7','class'=>'form-control'));?>
                </div>
            </div>
        </div>
        <h3>收費</h3>
