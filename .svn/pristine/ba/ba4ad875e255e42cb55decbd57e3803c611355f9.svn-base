...
<div class="row  m-a-1" id="payitemlayout">
...
<div class="panel box" id="successlayout" style="display: none">
    <div class="box-cell p-y-2 p-x-3 valign-middle">
        ...
        <div class="col-xs-6 text-center">
            <p class="text-success font-size-34">收款成功</p>
            <a href="" id="reprinttbn" class="openasnew btn btn-default btn-lg"><i class="fa fa-print"></i> 重印收據</a>
            <?=$this->Html->link("<i class='fa fa-edit'> 建立新收款</i>" , array("action"=>"newpayment"), array("class"=>"btn btn-lg btn-info", 'escape'=>false))?>
        </div>
        <div class="col-xs-2">
