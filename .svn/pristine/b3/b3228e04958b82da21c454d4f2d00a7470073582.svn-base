...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="form-group casereferral_other_agency" <?=(empty($this->request->data['Casereferralform']['other_agency']))?"hidden":""?>>
            ...
            <div class="form-group casereferral_other" <?=(empty($this->request->data['Casereferralform']['other_specify']))?"hidden":""?>>
