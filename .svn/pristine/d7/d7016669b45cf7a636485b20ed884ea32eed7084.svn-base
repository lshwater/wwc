...
<div class="modal-body">
    ...
    <ul id="uidemo-tabs-default-demo" class="nav nav-tabs" data-tabs="tabs">
        ...
        <li>
            <a href="#member_info_more" data-toggle="tab"><?=__("更多個人資料")?></a>
        </li>
        <li>
    ...
    <div class="tab-content tab-content-bordered">
                    ...
                    <tbody>
                        ...
                        ?>
                          <tr>
                              ...
                              <td>
                                  <?php echo $this->Html->link('<span class="icon fa fa-pencil"></span> '.__('edit'), array("controller"=>"memberships", "action"=>"edit", $ms['id']), array('escape'=>false, 'class'=>'btn btn-warning btn-sm')); ?>
                              </td>
                          </tr>
                        <?}
                        }?>
        ...
        <div class="tab-pane" id="member_info_more">
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    <colgroup>
                        <col class="col-xs-3">
                    ...
                    <tbody>
                    <?php echo $this->element('Customtype/form_builder_table_group'); ?>
                    </tbody>
                </table>
            </div>
        </div>
            ...
            <table class="table table-bordered">
                ...
                ?>
                    <tr class="active">
                        ...
                        <td><?=($msr['Membertype']['default_period'])?($msr['period']):"永久"?></td>
                        <td><?=date("Y年m月d日", strtotime($msr['startdate']))?></td>
                        <td><?=($msr['Membertype']['default_period'])?date("Y年m月d日", strtotime($msr['enddate'])):""?></td>
                        <td><?=h($msr['User']['name'])?></td>
                        <td>
                            <?php echo ($msr['Membertype']['default_period'])?$this->Html->link('<span class="icon fa fa-pencil"></span> '.__('edit'), array("controller"=>"membershiprecords", "action"=>"edit", $msr['id']), array('escape'=>false, 'class'=>'btn btn-warning btn-sm')):""; ?>
                            <?php echo $this->Form->postLink(__('刪除'), array('controller'=>"membershiprecords", 'action' => 'delete', $msr['id']), array('class'=>"btn btn-sm btn-danger"), __('你確認要刪除續會記錄？')); ?>
                        </td>
                    </tr>
                <?
                }
