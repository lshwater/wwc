    ...
    <div class="col-sm-12">
        <div class="panel widget-messages">
            <div class="panel-heading">
                <span class="panel-title"><i class="panel-title-icon fa fa-pencil-square-o"></i> 編輯站內公佈</span>
            </div> <!-- / .panel-heading -->
            <div class="panel-body">
                ...
                <form action="" class="new-mail-form form-horizontal">
                    <div class="row form-group">
                        <?php echo $this->Form->label('Group', __('收件人'), 'col-sm-2 control-label'); ?>
                    ...
                    <div class="row form-group">
                        <?php echo $this->Form->label('needconfirm', __('閱讀統計'), 'col-sm-2 control-label'); ?>
                        <div class="col-sm-10">
                    ...
                    <div class="row form-group">
                        <?php echo $this->Form->label('summernote', __('內容'), 'col-sm-2 control-label'); ?>
                        <div class="col-sm-10">
                            <div id="summernote"><?=$this->data['Announcement']['content']?></div>
                        </div>
                    </div>
                    <div class="row form-group">
