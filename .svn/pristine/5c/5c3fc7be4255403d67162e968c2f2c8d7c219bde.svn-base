<div class="page-header">
    <div class="row">
        ...
        <h1 class="col-xs-12 col-sm-4 text-left-sm flashMessage">
            <i class="fa fa-suitcase page-header-icon"></i>&nbsp;&nbsp;<?=__("修改個案")?>
        </h1>
...
<ul class="breadcrumb">
    <li>
        <?=$this->Html->link(__("返回"), array("action"=>"view", $this->data['Casemanagement']['id']))?>
    </li>
    <li class="active"><?=__("修改個案")?></li>
</ul>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('applicationdate', array('div'=>false, 'label'=>false, 'class'=>'form-control casedatepicker', "type"=>"text"));?>
                </div>
            </div> <!-- / .form-group -->
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->Form->input('dateofapproval', array('div'=>false, 'label'=>false, 'class'=>'form-control casedatepicker', "type"=>"text"));?>
                </div>
            </div> <!-- / .form-group -->
        </div>
