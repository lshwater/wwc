...
<div class="page-header">
    <div class="row">
        ...
        <h1 class="col-xs-12 col-sm-4 text-left-sm flashMessage"><i class="fa fa-folder-o page-header-icon"></i>&nbsp;&nbsp;<?=__("時間表編制")?>
        </h1>
    </div>
</div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            calendar = $('#calendar').fullCalendar({
                                ...
                                header: {
                                    right: 'copy today agendaWeek prev,next'
                                },
                                validRange: {
                                ...
                                eventAfterzzΩΩΩΩzzzΩΩΩAllRender: function(){
