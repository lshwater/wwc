...
<div class="page-header">
    <div class="row">
        ...
        <h1 class="col-xs-12 col-sm-4 text-left-sm flashMessage"><i class="fa fa-folder-o page-header-icon"></i>&nbsp;&nbsp;<?=__("我的日程")?>
        </h1>
    </div>
</div>
...
//                'class'=>'form-control no-padding-hr select2-nosearch filterauto allowClear', 'placeholder'=>__("個案性質"), "options"=>$casenatures,'empty'=>true,
...
//                'div'=>false, 'label'=>false,
//                'class'=>'form-control no-padding-hr select2-nosearch filterauto allowClear', 'placeholder'=>__("個案類別"), "options"=>$casetypes, 'empty'=>true,
//                'id'=>"filter-casetype",
//            )
//        ); ?>
<!---->
...
<div class="modal fade" role="dialog" id="new_record">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo $this->Form->create('Servicerecord', array('url'=>array( 'controller'=>'servicerecords', 'action'=>'add_from_schedule'), 'class'=>'form-horizontal validate_form preventDoubleSubmission')); ?>
...
<script>
    $(document).ready(function () {
        ...
        calendar = $('#calendar').fullCalendar({
            ...
            events: {
                url: '<?=$this->Html->url(array('controller'=>'casemanagements','action'=>'ajax_myschedule_list'))?>',
                type: 'POST',
                // data: {
        ...
        var table = $('#jq-datatables').dataTable({
            ...
            "fnDrawCallback": function( oSettings ) {
                ...
                if(selected){
                    $('.select_case').each(function(){
                        if($(this).attr('data-case-id') == selected){
                            $(this).trigger('click');
                        }
                    })
                }
