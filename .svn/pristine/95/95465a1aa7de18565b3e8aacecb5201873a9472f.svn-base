                ...
                <table class="table table-bordered table-striped">
                    ...
                    foreach($relationship as $relation){
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $this->Html->link(h($relation['Relatedmember']['c_name'])." ".h($relation['Relatedmember']['e_name']), array("controller"=>"members", "action"=>"view", $relation['Relatedmember']['id']), array("class"=>"openmodal"))?></td>
